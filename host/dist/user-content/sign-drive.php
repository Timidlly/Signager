...
<div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
            <a class="navbar-brand brand-logo me-5" href="index.php"><img src="../../assets/images/signager_logo.png" class="me-2" alt="logo" /></a>
            <a class="navbar-brand brand-logo-mini" href="index.php"><img src="../../assets/images/signager_logo_mini.png" alt="logo" /></a>
        </div>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <li class="nav-item"> <a class="nav-link" href="manager-screens.php">Manager Screens</a></li>
                            <li class="nav-item"> <a class="nav-link" href="manager-payloads.php">Manager Payloads</a></li>
        ...
        <div class="main-panel">
            ...
            <footer class="footer">
                <div class="d-sm-flex justify-content-center justify-content-sm-between">
                    <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © <a href="https://www.signetron.in/" target="_blank">Signetron</a> 2023</span>
                </div>
            </footer>
            <!-- partial -->
        </div>
...
function addPreview(file, filePath) {
    ...
    if (file.type.startsWith('image/')) {
        element.innerHTML = `<img src="${URL.createObjectURL(file)}" class="img-fluid" style="width: 100%; height: 100px; object-fit: cover;">`;
